...
**结果**: ✅ 成功提取19条, 保存到 17_1746062415_20250501131855.srt
...
**结果**: ✅ 成功提取19条, 保存到 17_1746062415_20250501134701.srt


### 批量分析测试 (2025-05-01 13:47:23)
...
### 本地视频信息获取测试 (2025-05-01 13:47:52)

**假设**: VideoProcessor._get_video_info能获取信息

**操作**: 处理视频文件: 17.mp4

**结果**: ✅ 成功获取: {"duration": 117.0, "fps": 30.0, "frame_count": 3510, "width": 1080, "height": 1920, "resolution": "1080x1920", "format": "mp4", "has_audio": true}


### 本地音频提取测试 (2025-05-01 13:47:52)
...
### 本地字幕提取测试 (2025-05-01 13:48:04)

**假设**: _extract_subtitles_from_video能提取字幕

**操作**: 处理音频: 17_1746062415.wav, 热词ID: vocab-aivideo-4d73bdb1b5ef496d94f5104a957c012b

**结果**: ✅ 成功提取19条, 保存到 17_1746062415_20250501134804.srt


### 内容分析测试 (intent模式) (2025-05-01 13:48:25)
...
### 批量分析测试 (所有意图) (2025-05-01 13:49:07)
...
### 批量分析测试 (自定义意图) (2025-05-01 13:49:27)

**假设**: 能够对多个视频进行自定义意图分析

**操作**: 对当前视频进行自定义意图 ['product_features'] 批量分析
